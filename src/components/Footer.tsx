          ...
          <div className="md:col-span-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p className="text-emerald-400 font-black text-sm uppercase">Santiago Main</p>
              ...
              <div className="space-y-4">
                <p className="text-emerald-400 font-black text-sm uppercase">Guimba</p>
                <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <div className="space-y-4">
                <p className="text-emerald-400 font-black text-sm uppercase">Saguday</p>
                <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <div className="space-y-4">
                <p className="text-emerald-400 font-black text-sm uppercase">Cabarroguis</p>
                <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <div className="space-y-4">
                <p className="text-emerald-400 font-black text-sm uppercase">Sto. Domingo</p>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Purok 6 Zamora, Cabarroguis, Quirino
                </p>
                <p className="text-white font-bold text-sm">0917 504 2727</p>
